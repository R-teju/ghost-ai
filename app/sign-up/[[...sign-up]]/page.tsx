...
import { History, Share2, FileText, Zap, Lock } from "lucide-react"
            ...
            <div className="relative flex h-10 w-10 items-center justify-center">
              ...
              >
                <path
                  ...
                  fill="url(#ghostGradSU1)"
                />
                <defs>
                  <linearGradient id="ghostGradSU1" x1="5" y1="4" x2="50" y2="60" gradientUnits="userSpaceOnUse">
          ...
          <div className="flex-1 flex flex-col justify-center space-y-12 max-w-md my-auto">
            <div className="space-y-5">
              <div className="inline-flex items-center gap-2 rounded-full border border-indigo-500/25 bg-indigo-500/10 px-3.5 py-1.5">
                ...
                <span className="text-xs font-semibold text-indigo-300 tracking-wide uppercase">Free to get started</span>
              </div>
            ...
            <div className="flex lg:hidden items-center gap-3 mb-10 justify-center">
              <div className="relative flex h-9 w-9 items-center justify-center">
                ...
                >
                  <path
                    d="M32 4C17.088 4 5 16.088 5 31v29l9-7 9 7 9-7 9 7 9-7V31C50 16.088 37.912 4 32 4Z"
                    fill="url(#ghostGradSU2)"
                  />
                  <defs>
                    <linearGradient id="ghostGradSU2" x1="5" y1="4" x2="50" y2="60" gradientUnits="userSpaceOnUse">
                      <stop stopColor="#a5b4fc" />
                      <stop offset="1" stopColor="#818cf8" />
                    </linearGradient>
                  </defs>
